...
#sapply(paste0("Functions/",list.files("Functions/Results-Graphics", full.names=F, pattern='\\.[rR]$')), source)
source("Functions/Results-Graphics/res.transform.R")

source("Functions/Results-Graphics/f.lines.R")
source("Functions/Results-Graphics/f.plot.lines.R")
source("Functions/Results-Graphics/f.plot.bias.R")
source("Functions/Results-Graphics/f.plot.nvar.R")
source("Functions/Results-Graphics/f.plot.error.R")
source("Functions/Results-Graphics/f.train.error.R")
source("Functions/Results-Graphics/f.pop.error.R")
source("Functions/Results-Graphics/f.plot.train.error.R")

source("Functions/Results-Graphics/f.plot.lambda.error.R")
source("Functions/Results-Graphics/f.points.lambda.error.R")

source("Functions/Results-Graphics/f.table.R")

source("Functions/matrix.methods.R")
