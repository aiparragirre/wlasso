...
load("../Results/res_linear_scenario1.RData")
...
load("../Results/res_linear_scenario2.RData")
...
load("../Results/res_logistic_scenario1.RData")
...
load("../Results/res_logistic_scenario2.RData")
